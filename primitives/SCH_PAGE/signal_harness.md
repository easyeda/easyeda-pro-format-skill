...
→ [查看 JSON Schema](../../schemas/t-signal-harness.json)
...
- 成员图元类型: [TSignalHarnessLine](../../primitives/SCH_PAGE/signal_harness_line.md)
- 成员图元中的关联字段: `lineGroup` (指向容器 id)

SIGNAL_HARNESS 包含多个 SIGNAL_HARNESS_LINE，每个 LINE 的 lineGroup 必须指向 SIGNAL_HARNESS 的 id

## 示例

→ [查看示例](../../examples/SCH_PAGE/t-signal-harness.md)
