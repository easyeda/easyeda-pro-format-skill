...
| startShape | `EBothEndShape \| null` | ✓ | default: null | 取值范围：NONE（无）、ARROW（箭头）、SOLID_ARROW（实心箭头）、TAIL（尾巴）、SOLID_TAIL（燕尾箭头）、CIRCLE（圆形）、SQUARE（方形）、RHOMBUS（菱形） |
| endShape | `EBothEndShape \| null` | ✓ | default: null | 取值范围：NONE（无）、ARROW（箭头）、SOLID_ARROW（实心箭头）、TAIL（尾巴）、SOLID_TAIL（燕尾箭头）、CIRCLE（圆形）、SQUARE（方形）、RHOMBUS（菱形） |
