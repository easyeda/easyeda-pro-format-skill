...
（本行 id 是**复合 id**，见 [TCompositeElementId](../REFERENCE/t-composite-element-id.md)）。
...
→ [查看示例](../../examples/PCB/t-pcb-attr.md)
